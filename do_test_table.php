...
?>
<tr>
<td class="td1 center" nowrap="nowrap"><a href="<?php echo $_ENV['BASE_URL']; ?>/edit_tword.php?wid=<?php echo $record['WoID']; ?>" target="ro"><img src="<?php echo $_ENV['BASE_URL']; ?>/icn/sticky-note--pencil.png" title="Edit Term" alt="Edit Term" /></a></td>
