...
function backDropSource(width,height,Z){return '<iframe frameborder="0" scrolling="no" src="'+$_ENV.BASE_URL+'/javascript:false;" width="'+width+'" height="'+height+'" style="z-index: '+Z+';filter: Beta(Style=0,Opacity=0);"></iframe>';}
