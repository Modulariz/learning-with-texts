...
if (isset($_REQUEST['new'])) {
	...
	<h4>New Language <a target="_blank" href="info.htm#howtolang"><img src="<?php echo $_ENV['BASE_URL']; ?>/icn/question-frame.png" title="Help" alt="Help" /></a> </h4>

	<script type="text/javascript" src="<?php echo $_ENV['BASE_URL']; ?>/js/unloadformcheck.js" charset="utf-8"></script>	
	<form class="validate" action="<?php echo $_ENV['BASE_URL'].$_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return check_dupl_lang(0);">

	<table class="tab1" cellspacing="0" cellpadding="5">
	<tr>
	<td class="td1 center backlightyellow" colspan="2"><img src="<?php echo $_ENV['BASE_URL']; ?>/icn/wizard.png" title="Language Settings Wizard" alt="Language Settings Wizard" class="click" onclick="window.open('select_lang_pair.php', 'wizard', 'width=400, height=400, scrollbars=yes, menubar=no, resizable=yes, status=no');" /><br /><span class="click" onclick="window.open('select_lang_pair.php', 'wizard', 'width=400, height=400, scrollbars=yes, menubar=no, resizable=yes, status=no');"><img src="<?php echo $_ENV['BASE_URL']; ?>/icn/arrow-000-medium.png" title="-&gt;" alt="-&gt;" /> <b>Language Settings Wizard</b> <img src="<?php echo $_ENV['BASE_URL']; ?>/icn/arrow-180-medium.png" title="&lt;-" alt="&lt;-" /></span><br /><span class="smallgray">Select your native (L1) and study (L2) languages, and let the wizard set all language settings marked in yellow!<br />(You can adjust the settings afterwards.)</span></td>
	</tr>
	</table>
	...
	<td class="td1"><input type="text" class="notempty setfocus checkoutsidebmp" data_info="Study Language" name="LgName" id="LgName" value="" maxlength="40" size="40" /> <img src="<?php echo $_ENV['BASE_URL']; ?>/icn/status-busy.png" title="Field must not be empty" alt="Field must not be empty" /></td>
	</tr>
	<tr>
	<td class="td1 right backlightyellow">Dictionary 1 URI:</td>
	<td class="td1"><input type="text" class="checkdicturl notempty checkoutsidebmp" name="LgDict1URI" value="" maxlength="200" size="60" data_info="Dictionary 1 URI" /> <img src="<?php echo $_ENV['BASE_URL']; ?>/icn/status-busy.png" title="Field must not be empty" alt="Field must not be empty" /></td>
	</tr>
	<tr>
	...
	<td class="td1"><input type="text" class="notempty checkoutsidebmp" name="LgRegexpSplitSentences" value=".!?:;" maxlength="500" size="60" data_info="RegExp Split Sentences" /> <img src="<?php echo $_ENV['BASE_URL']; ?>/icn/status-busy.png" title="Field must not be empty" alt="Field must not be empty" /></td>
	</tr>
	<tr>
	...
	<td class="td1"><input type="text" class="notempty checkoutsidebmp" data_info="RegExp Word Characters" name="LgRegexpWordCharacters" value="a-zA-ZÀ-ÖØ-öø-ȳ" maxlength="500" size="60" /> <img src="<?php echo $_ENV['BASE_URL']; ?>/icn/status-busy.png" title="Field must not be empty" alt="Field must not be empty" /></td>
	</tr>
	<tr>
	...
	<tr>
	<td class="td1 right">Export Template <img class="click" src="<?php echo $_ENV['BASE_URL']; ?>/icn/question-frame.png" title="Help" alt="Help" onclick="oewin('info_export_template.htm');" /> :</td>
...
elseif (isset($_REQUEST['chg'])) {
	...
	if ($record = mysqli_fetch_assoc($res)) {
		...
		<h4>Edit Language <a target="_blank" href="info.htm#howtolang"><img src="<?php echo $_ENV['BASE_URL']; ?>/icn/question-frame.png" title="Help" alt="Help" /></a> </h4>
		<script type="text/javascript" src="<?php echo $_ENV['BASE_URL']; ?>/js/unloadformcheck.js" charset="utf-8"></script>	
		<form class="validate" action="<?php echo $_ENV['BASE_URL'].$_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return check_dupl_lang(<?php echo $_REQUEST['chg']; ?>);">
		<input type="hidden" name="LgID" value="<?php echo $_REQUEST['chg']; ?>" />
		<table class="tab1" cellspacing="0" cellpadding="5">
		<tr>
		<td class="td1 right">Study Language "L2":</td>
		<td class="td1"><input type="text" class="notempty setfocus checkoutsidebmp" data_info="Study Language" name="LgName" id="LgName" value="<?php echo tohtml($record['LgName']); ?>" maxlength="40" size="40" /> <img src="<?php echo $_ENV['BASE_URL']; ?>/icn/status-busy.png" title="Field must not be empty" alt="Field must not be empty" /></td>
		</tr>
		<tr>
		<td class="td1 right">Dictionary 1 URI:</td>
		<td class="td1"><input type="text" class="notempty checkdicturl checkoutsidebmp" name="LgDict1URI" value="<?php echo tohtml($record['LgDict1URI']); ?>"  maxlength="200" size="60" data_info="Dictionary 1 URI" /> <img src="<?php echo $_ENV['BASE_URL']; ?>/icn/status-busy.png" title="Field must not be empty" alt="Field must not be empty" /></td>
		</tr>
		<tr>
		<td class="td1 right">Dictionary 2 URI:</td>
		...
		<td class="td1"><input type="text" class="notempty checkoutsidebmp" name="LgRegexpSplitSentences" value="<?php echo tohtml($record['LgRegexpSplitSentences']); ?>" maxlength="500" size="60" data_info="RegExp Split Sentences" /> <img src="<?php echo $_ENV['BASE_URL']; ?>/icn/status-busy.png" title="Field must not be empty" alt="Field must not be empty" /></td>
		</tr>
		<tr>
		<td class="td1 right">Exceptions Split Sentences:</td>
		...
		<td class="td1"><input type="text" class="notempty checkoutsidebmp" data_info="RegExp Word Characters" name="LgRegexpWordCharacters" value="<?php echo tohtml($record['LgRegexpWordCharacters']); ?>" maxlength="500" size="60" /> <img src="<?php echo $_ENV['BASE_URL']; ?>/icn/status-busy.png" title="Field must not be empty" alt="Field must not be empty" /></td>
		</tr>
		<tr>
...
<p><a href="<?php echo $_ENV['BASE_URL'].$_SERVER['PHP_SELF']; ?>?new=1"><img src="<?php echo $_ENV['BASE_URL']; ?>/icn/plus-button.png" title="New" alt="New" /> New Language ...</a></p>
...
while ($record = mysqli_fetch_assoc($res)) {
	...
	if ( $current == $record['LgID'] ) {
		$tdth = 'th';
		echo '<th class="th1"><img src="'.$_ENV['BASE_URL'].'/icn/exclamation-red.png" title="Current Language" alt="Current Language" /></th>';
	} else {
		$tdth = 'td';
		echo '<td class="td1 center"><a href="'.$_ENV['BASE_URL'].'/save_setting_redirect.php?k=currentlanguage&amp;v=' . $record['LgID'] . '&amp;u=edit_languages.php"><img src="'.$_ENV['BASE_URL'].'/icn/tick-button.png" title="Set as Current Language" alt="Set as Current Language" /></a></td>';
	}
	echo '<' . $tdth . ' class="' . $tdth . '1 center"><a href="'.$_ENV['BASE_URL'].'/do_test.php?lang=' . $record['LgID'] . '"><img src="'.$_ENV['BASE_URL'].'/icn/question-balloon.png" title="Test" alt="Test" /></a></' . $tdth . '>';
	echo '<' . $tdth . ' class="' . $tdth . '1 center" nowrap="nowrap">&nbsp;<a href="' . $_ENV['BASE_URL'].$_SERVER['PHP_SELF'] . '?chg=' . $record['LgID'] . '"><img src="'.$_ENV['BASE_URL'].'/icn/document--pencil.png" title="Edit" alt="Edit" /></a>';
	if ($textcount == 0 && $archtextcount == 0 && $wordcount == 0) 
		echo '&nbsp; <span class="click" onclick="if (confirmDelete()) location.href=\'' . $_ENV['BASE_URL'].$_SERVER['PHP_SELF'] . '?del=' . $record['LgID'] . '\';"><img src="'.$_ENV['BASE_URL'].'/icn/minus-button.png" title="Delete" alt="Delete" /></span>';
	else 
		echo '&nbsp; <img src="'.$_ENV['BASE_URL'].'/icn/placeholder.png" title="Delete not possible" alt="Delete not possible" />';
	echo '&nbsp;</' . $tdth . '>';
	echo '<' . $tdth . ' class="' . $tdth . '1 center">' . tohtml($record['LgName']) . '</' . $tdth . '>';
	if ($textcount > 0) 
		echo '<' . $tdth . ' class="' . $tdth . '1 center"><a href="'.$_ENV['BASE_URL'].'/edit_texts.php?page=1&amp;query=&amp;filterlang=' . $record['LgID'] . '">' . $textcount . '</a> &nbsp;&nbsp; <a href="' . $_ENV['BASE_URL'].$_SERVER['PHP_SELF'] . '?refresh=' . $record['LgID'] . '"><img src="'.$_ENV['BASE_URL'].'/icn/lightning.png" title="Reparse Texts" alt="Reparse Texts" /></a>';
	else
		echo '<' . $tdth . ' class="' . $tdth . '1 center">0 &nbsp;&nbsp; <img src="'.$_ENV['BASE_URL'].'/icn/placeholder.png" title="No texts to reparse" alt="No texts to reparse" />';
	echo '</' . $tdth . '>';
	echo '<' . $tdth . ' class="' . $tdth . '1 center">' . ($archtextcount > 0 ? '<a href="'.$_ENV['BASE_URL'].'/edit_archivedtexts.php?page=1&amp;query=&amp;filterlang=' . $record['LgID'] . '">' . $archtextcount . '</a>' : '0' ) . '</' . $tdth . '>';
	echo '<' . $tdth . ' class="' . $tdth . '1 center">' . ($wordcount > 0 ? '<a href="'.$_ENV['BASE_URL'].'/edit_words.php?page=1&amp;query=&amp;text=&amp;status=&amp;filterlang=' . $record['LgID'] . '&amp;status=&amp;tag12=0&amp;tag2=&amp;tag1=">' . $wordcount . '</a>' : '0' ) . '</' . $tdth . '>';
	echo '<' . $tdth . ' class="' . $tdth . '1 center">' . (isset($record['LgExportTemplate']) ? '<img src="'.$_ENV['BASE_URL'].'/icn/status.png" title="Yes" alt="Yes" />' : '<img src="'.$_ENV['BASE_URL'].'/icn/status-busy.png" title="No" alt="No" />' ) . '</' . $tdth . '>';
	echo '</tr>';
}
mysqli_free_result($res);
